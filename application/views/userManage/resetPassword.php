...
<div class="container-fluid data-main">
    <div class="panel panel-default">
        ...
        <div class="panel-body pad-tb-50">
            <form id="validateForm" class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="password" class="form-control" id="new_password" name="new_password" placeholder="新密码" maxlength="18">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="password" class="form-control" id="confirmed_password" name="confirmed_password" placeholder="重复密码" maxlength="18">
                    </div>
                    <div class="col-sm-6 form-tip"></div>
                </div>
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <button class="btn btn-primary" id="ok_btn"><i class="glyphicons glyphicons-ok fn-mr-5"></i>确认重置</button>
                    </div>
                </div>
            </form>
        </div>
