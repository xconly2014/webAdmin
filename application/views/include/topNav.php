<nav class="navbar navbar-fixed-top head-nav">
    <div class="container-fluid">
        <div class="navbar-header">
            <a href="/" class="navbar-brand">三叉戟游戏管理后台</a>
        </div>
        <div class="navbar-collapse collapse" id="navbar">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li>
                    <a href="user/"><i class="i-global i-product"></i>设置</a>
                </li>
                <!--<li>
                ...
                <li class="dropdown" data-tab="hoverdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="User/"><i class="glyphicons glyphicons-user-asterisk fn-mr-10"></i>修改密码</a></li>
                        <li><a href="User/"><i class="glyphicons glyphicons-user-key fn-mr-10"></i>重置密码</a></li>
